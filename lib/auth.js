...
// The role in getCurrentUser() comes from signup metadata — fine for
// showing the right navbar links, but NOT trustworthy for admin checks
// (metadata is client-supplied). This reads the role from the profiles
// table, which the database controls. Use it wherever "is this an admin?"
// matters.
